...
census_api_key("c8fe079555b37f7ba964e5d3d000e4ddd242d9ba", install = FALSE)
```
...
```{r}     
census_api_key("c8fe079555b37f7ba964e5d3d000e4ddd242d9ba", install = TRUE)
```
